...
public class ThePlayerGame {
	...
	public static void orders (String people[], String cake[], String frosting[], String toppings[], Player Eric){
		...
		loop1: while (orders){
			...
			String copy1 = scan2.next();
			if (copy1.equals((people[random]) + " - " + (cake[random1]) + " - " + (frosting[random2]) + " - " + (toppings[random3]))||copy1.equals("Eric II - Pretty Pretty Princess Cake- Cream Cheese Frosting - Gummy Bears Topping")){
			//if (copy1.equals((people[random]) + " - " + (cake[random1]) + " - " + (frosting[random2]) + " - " + (toppings[random3]))||copy1.equals((people[random]) + " - " + (cake[random1]) + " - " + (frosting[random2]) + " - " + (toppings[random3]))){	
